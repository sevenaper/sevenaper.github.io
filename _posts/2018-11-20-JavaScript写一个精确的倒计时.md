---
title: 使用JavaScript写一个精确的倒计时
key: 20181120
tags: JavaScript
---

关于写倒计时大家可能都都比较熟悉，使用 setTimeout 或 setInterval 就可以搞定。几秒钟或者几分钟的倒计时这样写没有问题，但是如果是长时间的倒计时，这样写就会不准确。并且如果用户更改他设备的时间，那么使用上述函数的倒计时就没有任何意义。下面介绍一个精确的倒计时方法。
...
![img](https://img.alicdn.com/tfs/TB1LBzjOpXXXXcnXpXXXXXXXXXX-154-71.png)
